        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Milliliters = table.Column<int>(type: "int", nullable: true),
                    Type = table.Column<int>(type: "int", nullable: true),
                    Count = table.Column<int>(type: "int", nullable: true),
                    Grams = table.Column<int>(type: "int", nullable: true),
                    Sushi_Count = table.Column<int>(type: "int", nullable: true),
                    Sushi_Type = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SushiAssignments", x => new { x.SushiID, x.ComboID });
                    table.ForeignKey(
